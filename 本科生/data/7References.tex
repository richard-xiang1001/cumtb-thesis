...
\begingroup
    ...
    % 修正参考文献标签：宋体数字，左顶格，折行缩进对齐（规范 3.8.1）
    \makeatletter
    ...
    \begin{thebibliography}{99}
        ...
        % 英文参考文献条目示例（如需 Times New Roman，在条目前加 \rmfamily）
        % \bibitem{ref12} {\rmfamily Smith J, Brown K. Title of English paper[J]. Journal Name, 2020, 1(2): 100-110.}
    \end{thebibliography}
\endgroup
